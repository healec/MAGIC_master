      subroutine restart(meqn,mbc,mx,&
     ...
     character*20 fname
     integer :: mpi_comm_3d, id, id_coords(3), ierr
...
!    write(*,*),fname
!    write(*,*) 'dimsf(1)', dimsf(1)
!    write(*,*) 'dimsf(2)', dimsf(2)
!    write(*,*) 'dimsf(3)', dimsf(3)
!    write(*,*) 'dimsf(4)', dimsf(4)
...
!     call h5pset_dxpl_mpio_f(plist_id, h5fd_mpio_collective_f, ierr)
     ...
     &data_out(1:10,1:mx,1:my,&
     &1:mz), dimsf, ierr)

      call mpi_barrier(mpi_comm_3d, ierr)

        write(*,*),data_out(1,1,1,1)
!	write(*,*),data_out(1,10,10,10)
